...
/// Macro to display the timing result for various number and types of arguments
#[macro_export]
...
//     ($method: ident, $clear_s1: ident, $encrypted_s1: ident, $clear_s2: ident, $return_type:
// ident, $padding_s1: expr) => {         let mut encrypted_s1 = $encrypted_s1.clone();
